                    ...
                    >
                        {sortedProducts.map((product, index) => (
                            ...
                            >
                                ...
                                {/* Quick View Button (Outside of Link to prevent navigation) */}
                                <div className="absolute top-[35%] left-1/2 -translate-x-1/2 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 w-10/12 pointer-events-none group-hover:pointer-events-auto z-20">
                                    <button 
                                        onClick={(e) => handleQuickView(e, product.id)}
                                        className="w-full bg-white/95 backdrop-blur-md text-brand-primary py-3 rounded-xl text-sm font-bold shadow-xl active:scale-95 transition-transform hover:bg-white flex items-center justify-center gap-2"
                                    >
                                        QUICK VIEW
                                    </button>
                                </div>
